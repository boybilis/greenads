...
function printPurchaseOrder(po, previewWin) {
    ...
    const printable =
        ...
        '<div class="grid"><div><div class="section-title">Supplier Details</div><div><strong>VENDOR NAME:</strong> ' + escapeHtml(supplier.supplier_name || '-') + '</div><div><strong>CONTACT PERSON:</strong> ' + escapeHtml(supplier.supplier_owner || '-') + '</div><div>Address: ' + escapeHtml(supplier.address || '-') + '</div><div>' + escapeHtml(supplier.contact_no || '-') + '</div><div>Email: ' + escapeHtml(supplier.email || '-') + '</div></div><div><div class="section-title">Prepared By</div><div>' + escapeHtml(po.created_by || '') + '</div></div></div>' +
